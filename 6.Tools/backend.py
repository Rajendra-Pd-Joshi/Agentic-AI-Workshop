...
def search_web(query: str, max_results: int = 5) -> str:
    ...
    Useful for current events, recent news, or anything not in Wikipedia.
    Args:
    ...
    try:
        ...
        return "The 'duckduckgo-search' package is not installed. Run: pip install duckduckgo-search"
    except Exception as exc:
...
- If a tool returns an error, explain it naturally and offer alternatives.
